<jsp:include page="../traineHeader.jsp">
	<jsp:param value="FeedBackForm" name="pageTitle" />
</jsp:include>
...
<spring:form modelAttribute="commonBean" action="save.htm">
<div class="box"  >
<br>
<h2 align="center">Training Feedback Form</h2>
		<table >
			...
			<tr>
				...
				<td style="position: absolute;"><input type="text" name="dateofFeedback" id="dateofFeedback" value="${today}" readonly="readonly"><spring:errors path="dateOfFeedback" ></spring:errors></td>
				<td><pre>                    </pre></td>
				<th><spring:label path="">Faculty</spring:label></th>
				<td><input type="text" name="facultyName" value="${emp.employeeName}" readonly="readonly"></td>
			</tr>
			<tr>
				<th align='left'><spring:label path="">Title</spring:label></th>
				<td ><input type="text" name="feedbackTitle" value="${tra.trainingName}" readonly="readonly"/></td>
			</tr>
	...
	<td align="right"><input type="submit" value="Save" class="btnLogin" style="align:center; float:none;"/></td>
	</tr></table>
